    ...
    <div>
      ...
      <div class="graphs-container">
        ...
        <div class="graph-item">
          <h3 class="graph-title">Playlists Network Graph</h3>
          <div class="graph-content">
            <!-- Replace the Timeline component with the NetworkGraph component -->
            <NetworkGraph :isMobile="screenSize.isSmall" />
          </div>
        </div>
      </div>
    </div>
...
import NetworkGraph from "~/pages/components/network-graph.vue"; // Import the NetworkGraph component
